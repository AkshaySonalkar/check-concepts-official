package com.checkconcepts.test;
...
import com.checkconcepts.Application;
...
import com.checkconcepts.spring.TestDbConfig;
import com.checkconcepts.spring.TestIntegrationConfig;
...
public class DeviceServiceIntegrationTest {
    ...
    public void givenValidLoginRequest_whenNoPreviousKnownDevices_shouldSendLoginNotification() {
        ...
        assertEquals("http://localhost:" + port + "/adminConsole", response.getHeader("Location"));
